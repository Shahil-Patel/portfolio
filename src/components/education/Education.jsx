import "./education.scss";
  ...
  return (
    <div className="education" id = "education">
            ...
            <h3 className="extra">Weighted GPA: 4.36/4.0</h3>
            <h3 className="courseWork">Relevant Coursework:</h3>
            <h3 className="extraCoursework">Data Structures, Android Mobile App Development, Virtual Reality & Game Design, Calculus BC, AP Statistics, Multivariable Calculus and Linear Algebra, AP Computer Science </h3>
        </div>
  );
}